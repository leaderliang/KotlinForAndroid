 ...
 * Property 相当于 java 中的 field + com.kotlin.practice.expressions.operators.get + set
 *
 * 这里的 com.kotlin.practice.expressions.operators.get 和 set 默认可以不写，也可以自定义书写
 *
...
//        com.kotlin.practice.expressions.operators.get() = 3
        get() {
            return 3
        }
        set(value) {}
